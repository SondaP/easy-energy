...
<div class="container">
    ...
    <!-- Punct Item -->
    <article class="punct-item" data-ng-repeat='receiverPointList in content.receiverPointList' ng-controller="ShowHideController as show">
        <nav class="navbar navbar-default">
            <span class="btn btn-primary glyphicon  pull-left" ng-class="Data.status[$index]" aria-hidden="true" data-ng-click='show.showhide($index)'></span>
            <p class="navbar-text">
            ...
            <article class="col-xs-12 no-padding calc-offer" data-ng-show="content.offerCalculationPerReceiverPointSet">
                ...
                <article class="col-xs-12 offers-retailers">
                    <article class="offers-retailers-item" data-ng-repeat='proposalSellerList in receiverPointList.receiverPointOfferCalculation.proposalSellerList' ng-controller='ShowHideCalculationCtrl as hideCalc'>
                        <nav class="navbar navbar-default">
                            <span class="btn btn-danger glyphicon  pull-left" ng-class="hideCalc.statusCalculation" aria-hidden="true" data-ng-click='hideCalc.showhideCalculation()'></span>
    ...
    <article class="col-xs-12 no-padding calc-offer-out" data-ng-hide="content.offerCalculationPerReceiverPointSet">
        ...
        <article class="col-xs-12 offers-retailers">
            <article class="offers-retailers-item" data-ng-repeat='proposalSellerList in content.allReceiverPointsOfferCalculation.proposalSellerList' ng-controller='ShowHideCalculationCtrl as calc'>
                <nav class="navbar navbar-default">
                    <p class="navbar-text">
                        <span class="btn btn-danger glyphicon  pull-left" ng-class="calc.statusCalculation" aria-hidden="true" data-ng-click='calc.showhideCalculation()'></span> {{$index+1}}. Kalkulacja ({{proposalSellerList.sellerCode}})</p>
                    <span class="navbar-brand glyphicon glyphicon-trash" aria-hidden="true" data-ng-click='removeOfferRetailer($index,$parent.$index)'></span>
                </nav>
    ...
    <article class="col-xs-12 no-padding summary-info" ng-controller='ShowHideController as showSumary'>
        <nav class="navbar navbar-default">
            <span class="btn btn-warning glyphicon  pull-left" ng-class="showSumary.statusSummary" aria-hidden="true" data-ng-click='showSumary.showhideSumary()'></span>
        ...
        <div class="summary-info-container" ng-hide='showSumary.isSummaryHide'>
            <h2>Estymacja dla punktu odbioru</h2>
